...
class Mob {
    ...
    public void confirmAttributeChanges() {
        ...
        if (equippedArmor != null && equippedWeapon != null) {
            equipGear(equippedArmor, equippedArmorLVL, equippedWeapon, equippedWeaponLVL);
        }
...
class Battle {
    ...
    // use skill method here
    public Mob useSkill(String skillUsed, Mob attackedMob) {
...
public class Game extends javax.swing.JFrame {
    ...
    private void moveDialogue() {
        ...
        if (dialogueIndex < 6 && textIndex < 9) {
            ...
            if (dialogueIndex == 7 && textIndex == 19) {

                // method this
                enemy = new Mob();
                enemy.generateMob("Slime", "Madeis", 1, "", 0, "", 0);
